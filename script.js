...
async function solveSudoku() {
    ...
    for (let row = 0; row < gridSize; row++) {
        ...
        for (let col = 0; col < gridSize; col++) {
            ...
            if (cellValue !== "" && (!isValidInput(cellValue) || !isValidMove(sudokuArray, row, col, parseInt(cellValue)))) {
                alert("Invalid input. Please enter numbers from 1 to 9 or leave the cell empty.");
                return;
            }
...
function isValidInput(value) {
    // Check if the input value is a number from 1 to 9
...
function clearSudokuBoard() {
    ...
    for (let row = 0; row < gridSize; row++) {
        for (let col = 0; col < gridSize; col++) {
            ...
            // Clear input values and remove classes
            cell.value = "";
